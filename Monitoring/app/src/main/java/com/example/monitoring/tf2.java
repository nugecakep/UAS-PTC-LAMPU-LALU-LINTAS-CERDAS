...
public class tf2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.loadUrl("http://172.20.10.2/cam-hi.jpg?" + System.currentTimeMillis());
